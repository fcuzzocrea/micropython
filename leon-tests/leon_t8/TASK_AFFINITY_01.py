...
# Test ID: TASK_AFFINITY_01
# Test description: Do heavy processing (compute digits of pi) in multiple tasks,
#                   all running on the same CPU.  This tests setting affinity and
#                   provides a contrast to TASK_AFFINITY_02 and TASK_AFFINITY_03.
