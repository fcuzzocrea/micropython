...
#
# SMP execution stress test, which does heavy processing in multiple tasks.
# Based on micropython/tests/stress_aes.py (see text below).
...
def test(n_loop):
    ...
    for loop in range(n_loop):
        ...
        # Verify the data is the same after encryption and decryption.
