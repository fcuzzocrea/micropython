...
print(np.min(a, axis=0))
print(np.min(a, axis=1))
a = np.array([range(2**30-3, 2**30),range(2**16-3, 2**16),range(2**8-3, 2**8)], dtype=np.float)
print(np.min(a))
print(np.min(a, axis=0))
print(np.min(a, axis=1))
...
b = np.array([range(2**30-3, 2**30),range(2**16-3, 2**16),range(2**8-3, 2**8)], dtype=np.float)
