...
// math constants
#if ULAB_NUMPY_HAS_E
ULAB_DEFINE_FLOAT_CONST_AB(ulab_const_float_e, MP_E);
#define ULAB_FLOAT_CONST_ulab_const_float_e ULAB_DEFINE_FLOAT_CONST_CD(0x402df854UL, 0x4005bf0a8b145769ULL)
#endif

#if ULAB_NUMPY_HAS_INF
ULAB_DEFINE_FLOAT_CONST_AB(numpy_const_float_inf, (mp_float_t)INFINITY);
#define ULAB_FLOAT_CONST_numpy_const_float_inf ULAB_DEFINE_FLOAT_CONST_CD(0x7f800000UL, 0x7ff0000000000000ULL)
#endif

#if ULAB_NUMPY_HAS_NAN
ULAB_DEFINE_FLOAT_CONST_AB(numpy_const_float_nan, (mp_float_t)NAN);
#define ULAB_FLOAT_CONST_numpy_const_float_nan ULAB_DEFINE_FLOAT_CONST_CD(0x7fc00000UL, 0x7ff8000000000000ULL)
#endif

#if ULAB_NUMPY_HAS_PI
ULAB_DEFINE_FLOAT_CONST_AB(ulab_const_float_pi, MP_PI);
#define ULAB_FLOAT_CONST_ulab_const_float_pi ULAB_DEFINE_FLOAT_CONST_CD(0x40490fdbUL, 0x400921fb54442d18ULL)
#endif
