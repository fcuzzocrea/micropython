...
static TIMELINE_ENTRY_T timeline[] = {
    ...
    //{ .delay_msec = 0, { .data = { 1,  0,  0 }, .len = 3 } },
    //{ .delay_msec = 0, { .data = { 1,  1,  0 }, .len = 3 } },
    //{ .delay_msec = 0, { .data = { 0, K_EPS_APID,  55,  0 }, .len = 3 } },
    //{ .delay_msec = 0, { .data = { 0, K_TCS_APID,  1,  0 }, .len = 3 } },
    //{ .delay_msec = 0, { .data = { 0, K_EPS_APID,  56,  10, 11, 12, 13}, .len = 6 } },
};
...
static rtems_status_code send_mpy_load(rtems_id q_id, TC_t *tc) {
    ...
    /*
    uint32_t mpy_base = MPY_MEM_BASE + mpy_id * MPY_MEM_STRIDE;
    uint32_t mpy_len = *(uint32_t*)mpy_base;
    uint8_t *mpy_src = (uint8_t*)(mpy_base + 4);
    */
